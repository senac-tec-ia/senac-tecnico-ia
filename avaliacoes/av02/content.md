...
**Tipo:** MP — Mini Projeto · **Em dupla** · **Entrega por e-mail**

**UCs:** UC07 — Transformação Digital · **Tempo estimado:** 2 a 3 horas

---

Vocês visitaram a **Limber** e tiveram a oportunidade de conhecer como uma empresa real funciona por dentro. Agora é hora de transformar essa experiência em um **relatório formal**.

O relatório deve ser escrito em dupla, no Word, formatado em **ABNT**, e entregue como **PDF por e-mail**.

---

## O que entregar

Um documento Word salvo como PDF com **4 seções obrigatórias**:
...
- Como os times se comunicam no dia a dia?
...
- Quais são os principais diferenciais ou concorrentes?
...
- Qual ferramenta ou modelo é utilizado? (ChatGPT, Gemini, Copilot, solução interna…)
...
- Qual é a estratégia de negócio da Limber para os próximos anos?
- A IA já faz parte do plano estratégico ou ainda é experimental?
...
- Qual foi a sua percepção: a empresa está preparada para a transformação digital?
...
**Prazo:** a confirmar pelo professor em aula.

---

## Checklist antes de enviar

- [ ] As 4 seções respondidas com texto próprio (mínimo 1 página cada)
- [ ] Capa com nomes completos e data
- [ ] Fonte Arial 12, espaçamento 1,5, margens ABNT
- [ ] Salvo como PDF
