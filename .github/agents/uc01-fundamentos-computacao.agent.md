...
2. Localize o bloco `## UC01 - Fundamentos de Computação` — se **não existir**, crie-o ao final do arquivo
...
- ✅ Edite apenas o próprio bloco `## UC01 - Fundamentos de Computação`
