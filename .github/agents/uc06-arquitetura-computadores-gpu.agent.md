...
2. Localize o bloco `## UC06 - Arquitetura de Computadores e GPU` — se **não existir**, crie-o ao final do arquivo
...
- ✅ Edite apenas o próprio bloco `## UC06 - Arquitetura de Computadores e GPU`
