...
- Transformação Digital + LGPD: 4 q
- Python básico: 4 q
- Inglês técnico: 4 q
...
**Para todos os papéis:** Leiam o artigo e respondam na folha:

1. _Qual foi a violação identificada no caso Serasa Experian?_
2. _Seu papel concorda ou discorda da prática? Por quê?_
3. _Que artigo da LGPD se aplica aqui? (dica: Art. 5º, 7º ou 18º)_
4. _O que deveria ter sido feito diferente pela Serasa?_

> Cite **pelo menos uma frase do artigo** nas suas respostas.
...
|---|---|
| Dados públicos = uso livre | Dados pessoais exigem base legal |
| Sem obrigação de informar | Titular tem direito de saber e revogar |
...
|---|---|---|---|
| **data breach** | /ˈdeɪtə briːtʃ/ | vazamento de dados | Os 223M CPFs foram expostos por um _data breach_ |
| **personal data** | /ˈpɜːs(ə)n(ə)l ˈdeɪtə/ | dados pessoais | CPF, nome e score são _personal data_ |
| **consent** | /kənˈsent/ | consentimento | Serasa não coletou _consent_ dos titulares |
| **compliance** | /kəmˈplaɪəns/ | conformidade legal | Empresas devem ter _compliance_ com a LGPD |
| **enforcement** | /ɪnˈfɔːsmənt/ | fiscalização/aplicação | A ANPD é o órgão de _enforcement_ no Brasil |
...
1. Copie a frase completa onde ele aparece
2. Explique com suas palavras o que significa naquele contexto
...
> - _"**Compliance** with LGPD requires a legal basis for data processing..."_
...
|---|---|---|
| **opt-out** | Revogação do consentimento | "Usuários têm direito ao _opt-out_" |
| **data subject** | Titular dos dados | "The _data subject_ has the right to access..." |
| **controller** | Controlador | "Serasa is the _data controller_ in this case" |
| **processor** | Operador | "A empresa processadora é o _data processor_" |
