...
> Aulas de reposição usam o prefixo `R`: `RA{NN}-UC{NN}.md`
...
| Tipo | Padrão | Exemplo |
|---|---|---|
| Slides de aula | `A{NN}-UC{NN}.md` | `A05-UC05.md` |
| Exercícios | `A{NN}-UC{NN}-exercicios.md` | `A05-UC05-exercicios.md` |
| Tarefa de casa | `A{NN}-tarefa.md` | `A05-tarefa.md` |
| Reposição | `RA{NN}-UC{NN}.md` | `RA07-UC01.md` |
| Agentes | `uc{NN}-{slug}.agent.md` | `UC05-python-para-ia.agent.md` |
...
|---|---|---|---|---|
| 1 | 7h10–9h30 | UC05 Python | `print()` aprofundado (f-string, sep, end), `type()`, conversão `float()`/`int()`, `float(input())`/`int(input())`, exercício livre: 3 notas via input + cálculo de média | 3 |
| 2 | 9h50–11h10 | — | Não chegou até este bloco | 0 |
| 3 | 11h10–12h00 | — | Não chegou até este bloco | 0 |

> Ritmo real: ~20 slides em 3 HA. Único exercício completo: EX-print() (sep/end/f-string) + exercício livre.
> Loops, listas, condicionais, operadores de comparação: NÃO cobertos. Ficam para A07+.

### A06 — 13/03 (Sex) ✅ Ministrada
...
| UC03 | Fundamentos Matemáticos | 13 | 0 | **13** | 🔴 Não iniciou |
