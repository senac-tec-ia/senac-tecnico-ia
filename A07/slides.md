...
- <carbon-chart-network /> O que é a **4ª Revolução Industrial**?
- <carbon-analytics /> O que é **Big Data**: dê um exemplo do seu cotidiano
- <carbon-hospital /> **IA em qual setor** você mais lembra das aulas anteriores?
- <carbon-portfolio /> Qual profissão você viu que **IA está transformando**?
...
| **Imagem** | Cria e edita imagens a partir de texto | Midjourney · DALL-E · Firefly |
| **Código** | Escreve, sugere e corrige código | GitHub Copilot · Cursor · Tabnine |
| **Voz / Áudio** | Clona voz, cria música, transcreve | ElevenLabs · Suno · Whisper |
...
# <carbon-image /> Família Imagem

## Como funciona: Midjourney · DALL-E 3 · Adobe Firefly

1. Você escreve um **texto descritivo** (prompt)
2. A IA interpreta cores, estilos e composição
3. Gera a imagem em segundos

> As imagens geradas são **originais**, não são cópias de imagens existentes. Adobe Firefly usa apenas conteúdo licenciado: é o mais seguro para uso profissional.
...
<!-- objetivo: aluno identifica casos de uso reais de ferramentas de geração de imagem -->

# <carbon-image /> Família Imagem: Onde Usar

## Casos de uso no dia a dia

- <carbon-color-palette /> **Portfólio e apresentações:** capas, slides, identidade visual
- <carbon-share /> **Redes sociais:** posts, thumbnails, banners
- <carbon-cube /> **Prototipagem:** visualizar produtos antes de existirem
- <carbon-book /> **Educação:** ilustrações para materiais didáticos
...
<!-- objetivo: aluno conhece Suno e Whisper e seus casos de uso práticos -->

# <carbon-microphone /> Família Voz: Suno e Whisper

## Música gerada por IA e transcrição automática

**Suno: Geração de Música**
- Cria músicas completas (letra + melodia) a partir de um texto
- Exemplo: *"Crie uma música de reggae sobre banco de dados"*
...
**<carbon-user /> Papel:** Defina quem a IA deve ser
> "Você é um professor de Python para iniciantes..."

**<carbon-information /> Contexto:** Dê o cenário
> "...estou aprendendo a programar, tenho 17 anos, nunca vi código antes..."

**<carbon-task /> Tarefa:** Diga exatamente o que quer
> "...explique o que é uma lista em Python..."

**<carbon-text-align-left /> Formato:** Especifique como quer a resposta
...
# <carbon-edit /> Exercício N3: Prompt do Zero
...
# <carbon-security /> LGPD Básico ao Usar IA

## O que você **não deve** colocar em ChatGPT, Claude ou qualquer IA

**Dados pessoais sensíveis (não colocar em IAs):**
...
# <carbon-terminal /> Hands-on: Terminal no VSCode
...
- <carbon-document /> **Currículo**: na maioria das vagas ainda se pede .docx ou .pdf
- <carbon-report /> **Relatório técnico**: resultado de projeto, trabalho escolar
- <carbon-pen /> **Contrato**: freelance, estágio, prestação de serviços
- <carbon-education /> **TCC / Monografia**: regras ABNT que o Word suporta nativamente
- <carbon-email /> **Ofício / Carta formal**: comunicações institucionais
...
**4. <carbon-folder-open /> Pasta correta**
...
# Formatação: Fonte e Espaçamento Padrão

## O que definir antes de começar a digitar
...
- <carbon-folder /> **Criar e nomear** com snake_case
- <carbon-ruler /> **Margens ABNT:** 3 cm sup/esq · 2 cm inf/dir
- <carbon-edit /> **Formatar:** Arial 12pt · 1,5 · justificado
...
# Flash Cards: 10 Termos de IA (1/2)

## Representação · Processamento · Arquitetura

| Termo | Definição funcional |
|---|---|
| **token** | Unidade mínima de texto que a IA processa (≈ palavra ou pedaço de palavra) |
| **embedding** | Representação numérica de uma palavra: a IA vê números, não letras |
...
# Flash Cards: 10 Termos de IA (2/2)

## Treino · Avaliação · Resultado
...
# <carbon-checkmark /> Gabarito: Quizão (1/2)

1. **loss** (erro do modelo; quanto menor, melhor)
2. **epoch** (uma passagem completa pelos dados de treino)
3. **layer** (camada da rede neural)
4. **pipeline** (sequência de etapas do dado bruto ao resultado)
...
# <carbon-checkmark /> Gabarito: Quizão (2/2)

5. **tokens** (pedaços em que o ChatGPT divide o texto)
6. **model** (arquivo com o resultado treinado)
7. **weight** (parâmetro ajustado durante o treino)
8. **embedding** (vetor do significado de uma palavra)
